...
def predict(
    ...
    outputs = [torch.Tensor([[object_prediction.bbox.minx,
                             object_prediction.bbox.miny,
                             object_prediction.bbox.maxx, 
                             object_prediction.bbox.maxy, 
                             1.,
                             object_prediction.score.value, 
                             object_prediction.category.id] \
                             for object_prediction in object_prediction_list \
                                if int(object_prediction.category.id) == 14])]

    img_info = {'height': prediction_result.image_height,
                'width': prediction_result.image_width,
                'raw_img': prediction_result.image,
                'img_path': ''}
