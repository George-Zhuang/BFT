...
class Exp(BaseExp):
    def __init__(self):
        ...
        self.model_path = "./checkpoint/yolox_x_8x8_300e_coco_20211126_140254-1ef88d67.pth"
        self.model_config_path = "./models/mmdet_yolox/yolox_x_8x8_300e_coco.py"
        self.model_device = "cuda:0" 
        self.model_confidence_threshold = 0.25
        self.overlap_height_ratio = 0.1
        self.overlap_width_ratio = 0.1
        self.slice_height = 256
        self.slice_width = 256
        self.no_sliced_prediction = False
